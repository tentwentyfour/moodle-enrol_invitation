...
$string['eventInvitationView'] = 'Invitation Viewed';
$string['eventPasswordFail'] = 'Password Failure';
$string['eventInvitationClaim'] = 'Invitation Claim';
$string['eventCreateUserFromInvitation'] = 'Create User From Invitation Claim';
